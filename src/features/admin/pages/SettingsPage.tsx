        ...
        <div className="p-12 cursor-auto">
            ...
            <div className="border-b border-white/10 mb-8">
                <button
                    ...
                    className={`px-6 py-4 font-mono uppercase text-sm tracking-wider transition-colors ${activeTab === 'services'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
                <div className="flex items-center justify-between mb-6">
                    <h2 className="text-3xl font-black uppercase tracking-tighter">Services List</h2>
                    <AdminButton
                        ...
                        services.map((service, idx) => (
                            ...
                            >
                                <AdminCard
                                    padding="md"
                                    hover
                                    className={`flex items-center justify-between ${editingService?.id === service.id ? 'ring-2 ring-white' : ''}`}
                                >
                                    <div className="flex items-center gap-3 flex-1">
                                        <GripVertical size={16} className="text-gray-500 cursor-grab" />
                                        <div className="flex-1">
                                            <div className="font-bold uppercase mb-1">{service.name}</div>
